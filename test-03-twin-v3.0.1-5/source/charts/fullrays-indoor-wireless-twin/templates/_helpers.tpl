...
*/}}
{{- define "fullrays-indoor-wireless-twin.name" -}}
...
*/}}
{{- define "fullrays-indoor-wireless-twin.chart" -}}
...
Selector labels
*/}}
{{- define "fullrays-indoor-wireless-twin.selectorLabels" -}}
app.kubernetes.io/name: {{ include "fullrays-indoor-wireless-twin.name" . }}
...
Common labels
*/}}
{{- define "fullrays-indoor-wireless-twin.labels" }}
app.kubernetes.io/name: {{ include "fullrays-indoor-wireless-twin.name" . }}
helm.sh/chart: {{ include "fullrays-indoor-wireless-twin.chart" . }}
{{ include "fullrays-indoor-wireless-twin.selectorLabels" . }}
app.kubernetes.io/version: {{ include "fullrays-indoor-wireless-twin.version" . }}
app.kubernetes.io/instance: {{ .Release.Name }}
{{- if .Chart.AppVersion }}
...
*/}}
{{- define "fullrays-indoor-wireless-twin.version" -}}
...
*/}}
{{- define "fullrays-indoor-wireless-twin.registryUrl" -}}
...
*/}}
{{- define "fullrays-indoor-wireless-twin.pullSecret.global" -}}
{{- $pullSecret := "" -}}
{{- if .Values.global -}}
...
*/}}
{{- define "fullrays-indoor-wireless-twin.pullSecret" -}}
{{- $pullSecret := (include "fullrays-indoor-wireless-twin.pullSecret.global" . ) -}}
...
*/}}
{{- define "fullrays-indoor-wireless-twin.registryImagePullPolicy.global" -}}
...
*/}}
{{- define "fullrays-indoor-wireless-twin.registryImagePullPolicy" -}}
    {{- $globalRegistryPullPolicy := (include "fullrays-indoor-wireless-twin.registryImagePullPolicy.global" . ) -}}
    {{- if .Values.imageCredentials -}}
...
*/}}
{{- define "fullrays-indoor-wireless-twin.pullSecrets" -}}
  {{- $pullSecret := "" -}}
  {{- if .Values.global -}}
      {{- if .Values.global.pullSecret -}}
          {{- $pullSecret = .Values.global.pullSecret -}}
...
Timezone variable
*/}}
{{- define "fullrays-indoor-wireless-twin.timezone" -}}
{{- $timezone := "UTC" -}}
{{- if .Values.global  -}}
...
*/}}
{{- define "fullrays-indoor-wireless-twin.appArmorProfile.type" -}}
...
*/}}
{{- define "fullrays-indoor-wireless-twin.appArmorProfileAnnotation" }}
...
*/}}
{{- define "fullrays-indoor-wireless-twin.fsGroup" -}}
  {{- if .Values.global -}}
...
*/}}
{{- define "fullrays-indoor-wireless-twin.seccomp-profile" }}
...
*/}}
{{- define "fullrays-indoor-wireless-twin.repoPath" -}}
...
{{- define "fullrays-indoor-wireless-twin.product-info" }}
...
*/}}
{{- define "fullrays-indoor-wireless-twin.jaegerEnv" }}
...
*/}}
{{- define "fullrays-indoor-wireless-twin.imagePath" }}
...
*/}}
{{- define "fullrays-indoor-wireless-twin.nodeSelector" -}}
{{- $globalValue := (dict) -}}
{{- if .Values.global -}}
...
{{- define "fullrays-indoor-wireless-twin.tolerations" -}}
...
*/}}
{{- define "fullrays-indoor-wireless-twin.terminationGracePeriodSeconds" -}}
...
*/}}
{{- define "fullrays-indoor-wireless-twin.securityPolicy.reference" -}}
  {{- if .Values.global -}}
...
*/}}
{{- define "fullrays-indoor-wireless-twin.securityPolicy.annotations" -}}
# Automatically generated annotations for documentation purposes.
{{- end -}}

{{/*
Get the client credentials secret name from global values
*/}}
{{- define "fullrays-indoor-wireless-twin.clientSecret" -}}
{{- $clientSecret := "" -}}
{{- if .Values.global -}}
