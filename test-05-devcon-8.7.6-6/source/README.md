...
"componentInstances": [
	{
		"name": "rapp-devcon-database-demo-app",
		"properties": {
			"userDefinedHelmParameters": {
				"postgresql-ha.global.imageRegistry": "<APP_MGR_HOST>/appmgr/images/rapp-ericsson-rapp-devcon-database-demo-app-3-2-2-0",
				"postgresql-ha.global.imagePullSecrets": [
					"hfe-generic-pull-secret"
				],
				"postgresql-ha.global.security.allowInsecureImages": true,
				"postgresql-ha.global.postgresql.existingSecret": "rapp-devcon-database-demo-app-postgresql-secret",
				"postgresql-ha.global.pgpool.existingSecret": "rapp-devcon-database-demo-app-pgpool-secret",
...
APP_NAME : Name of the application's ClusterIP service(inside k8s). Use `rapp-devcon-database-demo-app` if you have not made any changes to rApp helm chart.
